...
// Default specifications match the Excel template exactly
export const SOW_TEMPLATE = [
  ...
  // Application
  { section: 'Application', work_item: 'Application',          specification: 'MES',                          notes: '' },
  ...
  // Facilities — kept empty; DM fills in Manufacturing Location / Facility names
  ...
  // Process Configuration - Go Live
  { section: 'Process Configuration - Go Live', work_item: 'Templates - BMRs',     specification: '1',  notes: '' },
  { section: 'Process Configuration - Go Live', work_item: 'Templates - BPRs',     specification: '1',  notes: '' },
  { section: 'Process Configuration - Go Live', work_item: 'Templates - Logbooks', specification: '10', notes: '' },
  // Process Configuration - Scale-up
  { section: 'Process Configuration - Scale-up', work_item: 'Templates - BMRs',     specification: '25', notes: 'Scale up Tracker' },
  { section: 'Process Configuration - Scale-up', work_item: 'Templates - BPRs',     specification: '25', notes: '' },
  { section: 'Process Configuration - Scale-up', work_item: 'Templates - Logbooks', specification: '12', notes: '' },
  // Integrations
  ...
  { section: 'Integrations', work_item: 'Raw Material Weighing Balances', specification: 'Not in scope',  notes: '' },
  { section: 'Integrations', work_item: 'In Process Instruments',         specification: 'Not in scope',  notes: '' },
  { section: 'Integrations', work_item: 'Analytical Balances',            specification: 'Not in scope',  notes: '' },
  { section: 'Integrations', work_item: '[EQUIPMENT_1]',                  specification: 'Not in scope',  notes: '' },
  { section: 'Integrations', work_item: '[EQUIPMENT_2]',                  specification: 'Not in scope',  notes: '' },
  // Environment
  ...
  // Additional Languages — DM fills in language names
...
// Dropdown options keyed by work_item name — shown in Specification column.
// DMs can add project-specific options on top of these defaults.
export const SOW_DROPDOWN_OPTIONS = {
  'MSA':                            ['Signed', 'Not Signed', 'Pending'],
  'NDA':                            ['Signed', 'Not Required', 'Not Signed', 'Pending'],
  'Application':                    APPLICATIONS,
  'Cloud Management':               ['Leucine Managed', 'Customer Managed'],
  'Cloud Service':                  ['Azure', 'AWS', 'GCP', 'On-Premise'],
  'Data Backup frequency':          ['Daily', 'Weekly', 'Bi-weekly'],
  'Storage Account (S3)':           ['AWS', 'Azure', 'GCP', 'Not Required'],
  ...
  'Geo-fencing':                    ['Required', 'Not Required'],
  'SSO':                            ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'ERP':                            ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'LIMS':                           ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'QMS':                            ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'Raw Material Weighing Balances': ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'In Process Instruments':         ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'Analytical Balances':            ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  '[EQUIPMENT_1]':                  ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  '[EQUIPMENT_2]':                  ['Go Live scope', 'Post Go Live scope', 'Not in scope'],
  'Production':                     ['Required', 'Not Required'],
  'Quality':                        ['Required', 'Not Required'],
  'UAT':                            ['Required', 'Not Required'],
  'Share CSV Package':              ['Included', 'Not Included', 'Not applicable, already live'],
  'Hypercare Support':              ['30 Days', '60 Days', '90 Days', 'Not Required'],
};
...
export const MES_TASKS = [
  ...
  { milestone: 'Go-Live on Production', activities: 'Add Users and make user groups on Production server', tools: 'NA', owner: 'Client IT SME', status: 'Not Started', duration: 1, dependency: 'Train Users on the Operational SOP' },
  { milestone: 'Go-Live on Production', activities: 'Execute PQ', tools: 'NA', owner: 'Client Production SME', status: 'Not Started', duration: 4, dependency: 'Share IQ-PS and CPC for Production Server' },
  ...
  { milestone: 'Go-Live on Production', activities: 'Release System', tools: 'NA', owner: 'Client Project Manager', status: 'Not Started', duration: 1, dependency: 'Make MES SOP Effective' },
  // Hypercare
...
export const LOGBOOKS_TASKS = [
  ...
  { milestone: 'Go-Live on Production', activities: 'Add Users and make user groups on Production server', tools: 'NA', owner: 'Client IT SME', status: 'Not Started', duration: 1, dependency: 'Share IQ-PS and CPC for Production Server' },
...
export const PLAN_TEMPLATE = [
  ...
  { milestone: 'Go-Live on Production', activities: 'Add Users and make user groups on Production server',                     tools: 'NA',                                                   owner: '', duration: 1,  dependency: 'Train Users on the Operational SOP' },
  { milestone: 'Go-Live on Production', activities: 'Execute PQ',                                                               tools: 'NA',                                                   owner: '', duration: 4,  dependency: 'Share IQ-PS and CPC for Production Server' },
  ...
  { milestone: 'Go-Live on Production', activities: 'Release System',                                                           tools: 'NA',                                                   owner: '', duration: 1,  dependency: 'Make MES SOP Effective' },
  // ── Hypercare ────────────────────────────────────────────
